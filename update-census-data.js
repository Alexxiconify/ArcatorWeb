...
// Configuration
const GOOGLE_SHEETS_URL = process.env.GOOGLE_SHEETS_URL || 'https://docs.google.com/spreadsheets/d/1T25WAAJekQAjrU-dhVtDFgiIqJHHlaGIOySToTWrrp8/gviz/tq?tqx=out:csv&gid=1977273024';
...
async function updateCensusData() {
  try {
    ...
    console.log(`💾 Updated ${OUTPUT_FILE} with ${interestsData.length} interests`);
...
module.exports = {updateCensusData, parseCSV, getInterestCategory, getInterestDescription};
