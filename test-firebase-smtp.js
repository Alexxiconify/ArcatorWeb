...
async function runAllTests() {
  ...
  console.log('========================');
  console.log(`SMTP Connection: ${results.connection.success ? '✅ PASS' : '❌ FAIL'}`);
  console.log(`Single Email: ${results.singleEmail.success ? '✅ PASS' : '❌ FAIL'}`);
  console.log(`Bulk Emails: ${results.bulkEmails.success ? '✅ PASS' : '❌ FAIL'}`);
  console.log(`Firebase Functions: ${results.firebaseFunctions.success ? '✅ PASS' : '❌ FAIL'}`);
  ...
  if (passedTests === totalTests) {
    console.log('🎉 All tests passed! Firebase SMTP integration is working correctly.');
  } else {
